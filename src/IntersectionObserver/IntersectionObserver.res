...
*/
@send
external observe: (IntersectionObserverTypes.intersectionObserver, DOM.element) => unit =
  "observe"
...
*/
@send
external unobserve: (IntersectionObserverTypes.intersectionObserver, DOM.element) => unit =
  "unobserve"
