...
*/
@send
external extractContents: t => DocumentFragment.t = "extractContents"

/**
[Read more on MDN](https://developer.mozilla.org/docs/Web/API/Range/cloneContents)
*/
@send
external cloneContents: t => DocumentFragment.t = "cloneContents"
...
*/
@send
external createContextualFragment: (t, string) => DocumentFragment.t =
