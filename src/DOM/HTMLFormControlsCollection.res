...
external asHTMLCollection: t => HTMLCollection.t<DOMTree.element> = "%identity"
...
*/
@send
external item: (t, int) => DOMTree.element = "item"
...
*/
@send
external namedItem: (t, string) => DOMTree.element = "namedItem"
